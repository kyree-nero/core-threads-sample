...
public class LockConditionWidgetBuffer implements WidgetBuffer {
	...
	public Widget getWidget(String id) {
		...
		int tries = 0;
		while (widget == null) {
			System.out.println("[CONSUMER-" + id + "][TRIAL:" + tries + "] widgets   read: " + readIndex + " write: "
					+ writeIndex + " occupied: " + occupied + "");
	...
	public void putWidget(Widget widget) {
		...
		while (!produced) {
			System.out.println(
					"[PRODUCER] widgets   read: " + readIndex + " write: " + writeIndex + "occupied: " + occupied + "");
